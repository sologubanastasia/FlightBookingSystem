...
public class BookingService : IBookingService
{
    ...
    private readonly IFlightRepository _flightRepo; // Додано для завантаження даних перед мапінгом
    ...
    public async Task<BookingDto> CreateBookingAsync(Guid userId, CreateBookingDto dto)
    {
        ...
        // Завантажуємо Flight, щоб Mapper міг заповнити FlightId/FlightNumber у DTO
