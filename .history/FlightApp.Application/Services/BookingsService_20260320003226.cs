...
public class BookingService : IBookingService
{
    ...
    {
        // 1. Використовуємо dto.Seats (згідно з твоїм рекордом CreateBookingDto)
        ...
        var booking = new Booking
        {
            ...
            Status = Status.Confirmed, // Використовуємо Enum, а не string
        ...
        foreach (var seat in seats)
        {
            ...
            { 
                ...
                SeatId = seat.Id,
                Seat = seat // Додаємо посилання для коректної роботи
            };
        ...
        // 2. Якщо UpdateRange немає в інтерфейсі, можна оновити кожне крісло окремо
        foreach (var seat in seats)
        {
